...
class DeliveryController extends Controller
{
	...
	public function details(Request $request){
		...
		$result.='<div class="row row-cols-3">
                            ...
                            <div class="col-md-8">
                                <p style="white-space: normal;"><b>Postal/ Address: </b> '.$ro->site_address.'</p>
                            </div>
                        </div>
	...
	public function deliverydetails(Request $request){
		...
		$pickup_images = DB::table('dispute_images')->select('image')->Where('image_type','3')->where('job_id',$request['id'])->get();
	...
	public function next_date(Request $request){
		...
		$result .= '<li><div class="date-order">
					<table>
					<tr>
						<td style="text-align: left;"><b>RO</b>#'.$ro->order_id.'</td>
					</tr>
					<tr><th style="text-align: left;">'.$del->jobsheet_id.'</th></tr>
					<tr>
