    ...
    <div class="container-fluid">
		...
		<div class="box-shadow account">
			...
			<div class="filter">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
											...
											@endif
											<li><a class="dropdown-item popup" href="javascript:void(0);" data-id="{{$assign->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="las la-print" aria-hidden="true"></i>Print Jobsheet</a></li>	
				...
				@else
				<p class="noresult_assign">No result found.</p>
				@endif
...
<script>
 ...
 $('.popup').click(function (event) {
    ...
    var iframe = '<iframe src="https://erp.supremefloors.com.sg/print-jobsheet/'+inv_id+'"></iframe>';
        $('.appnd_iframe').empty('');
    $('.appnd_iframe').html(iframe);
