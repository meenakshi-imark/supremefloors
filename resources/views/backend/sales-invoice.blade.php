                    ...
                    <div class="row  row-cols-md-2 row-cols-1">
                        ...
                        <div class="col">
                            <div class="form-group form-select-group w-100">
                                ...
                                <div class="search-it">
                                    <i class="la la-search"></i>
                                    <input type="text" class="form-control attentionto" id="search" name="attentionto" placeholder="Search" required>
									<input id="supplierid" type="hidden" value="" name="supplierid">
                                </div>
                                <div class="red-error" style="display:none; color: red;margin-bottom: 6px;">Please enter a valid name.</div>
                            </div>
                        </div>
...
$(document).on("keyup", "#gst", function() {
 ...
 var val = parseInt(new_subtotal)+quotient;
