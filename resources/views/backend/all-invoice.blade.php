                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li><a class="dropdown-item popup" href="javascript:void(0);" data-id="{{$invoice->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="las la-print" aria-hidden="true"></i>Print Invoice</a></li>	
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    var iframe = '<iframe src="https://erp.supremefloors.com.sg/print-invoice/'+inv_id+'"></iframe>';
        $('.appnd_iframe').empty('');
