    ...
    <body>
        <div class="main-pdf">
            <div class="pdf-header">
                <div class="top-head">
                    <h2>Purchase Order Number: {{$orders->order_no}}</h2>
                    <figure>
            ...
            <div class="table-1">
                <table>
                    <tbody>
                        <tr>
                        @php 
                        $com = DB::table('suppliers')->select('company_name')->where('id',$orders->supplier_id)->first();
                        @endphp
                        @if($com)
                        ...
                        @endif
                            ...
                            <td>Date :</td>
                            <td><span>{{$orders->estimated_arrival}}</span></td>
                        </tr>
                        ...
                        <tr>
                            <td>Estimated Days Before Arrival :</td>
                            <td><span>{{$orders->estimated_arrival}}</span></td>
                            <td></td>
                            <td></td>
                        </tr>
                    ...
                    <tbody>
                      @for($i=0;$i<count($arr['products']);$i++)
                        ...
                        @endphp
                            ...
                            <td><span>${{($arr['quantity'][$i])*($arr['price'][$i])}}</span></td>
                        </tr>
                      @endfor
