                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
											...
											<li><a class="dropdown-item popup" href="javascript:void(0);" data-id="{{$install->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="las la-print" aria-hidden="true"></i>Print Installer Order</a></li>	
...
<script>
    ...
    var iframe = '<iframe src="https://erp.supremefloors.com.sg/print-installer-order/'+inv_id+'"></iframe>';
        $('.appnd_iframe').empty('');
