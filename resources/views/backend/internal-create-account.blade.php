...
<main class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="box-shadow role">
            ...
            @php
            $getlast = DB::table('users')->select('id')->orderBy('id','DESC')->first();
            $uid = $getlast->id+1;
            @endphp
            @if(strlen($uid)==1)
			@php $var = "00000".$uid; @endphp
			@elseif(strlen($uid)==2)
            @php $var = "0000".$uid; @endphp
            @elseif(strlen($uid)==3)
            @php $var = "000".$uid; @endphp
            @elseif(strlen($uid)==4)
            @php $var = "00".$uid; @endphp
            elseif(strlen($uid)==5)
            @php $var = "0".$uid; @endphp
            @else
            @php $var = $uid; @endphp
            @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="staff_id" class="form-control" value="SUP-{{$var}}" readonly>
                            </div>
                        </div>
                    </div>
